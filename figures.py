...
from single_cmpt import run_real_data
from matplotlib.font_manager import FontProperties
from plots import plot_most_likely_dynamics, plot_z_by_class
...
def plot_single_compartment(save_figure_name, x_smpl, V_true, V_obs, rslds, z_smpls, lps, x_smpls, t, I_inj_values, K=3):
    ...
    for seed1 in range(5, -1, -1):
        ...
        inputs = np.column_stack((np.ones((T_sim, 1)), I_inj_values[:T_sim]))
...
def run_comparison_realdata_noise():
    ...
    for i in range(len(noises)):
        ...
        mse, x_smpl, V_true, V_obs, rslds, z_smpls, lps, x_smpls, t, I_inj_values = \
            run_real_data(K, noise_std, sigmasq_value, penalty)
        MSE_K3.append(mse)
